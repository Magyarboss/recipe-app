...
//            guacNotes.setRecipe(guacRecipe); --not needed anymore cuz we put that logic inside Recipe - setNotes()
            guacRecipe.setNotes(guacNotes);

            // not needed anymore cuz we added new method public Recipe addIngredient(Ingredient ingredient) so we can make the code simpler - and also we overloaded ingredient constructor so we dont need to pass in the recipe
